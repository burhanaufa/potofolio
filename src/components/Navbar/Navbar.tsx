			...
			{LIST_MENU.map((menu, index) => {
				return (
					<a
						...
						onClick={onClose}
					>
						<span className="text-pink-400 pr-2">#{index + 1}.</span>
						{menu}
					</a>
				);
			})}
...
const Navbar: React.FC = () => {
	...
	return (
		<React.Fragment>
			...
			<div className="z-20 px-5 md:px-12 py-2 md:py-8 fixed flex justify-between items-center w-full  bg-darkBlue">
				<div></div>
